  ...
  return (
    <section className="py-20 text-center">
      ...
      <div className="flex justify-center space-x-4 mb-8">
        <Badge variant="outline" className="py-2 px-4 glassmorphism glow-element">
      ...
      <p className="max-w-2xl mx-auto text-muted-foreground">
        Software Engineer with 4 years of experience in enterprise-scale systems development, 
